...
<!-- Preloader -->
	...
	<div id="container" class="container">
		...
		<div id="content">
			...
			<section class="home wow fadeInLeft animated" id="about">
                <div class="content text-center">
                    <h1>Beta Version <span>Thanks for using iBand</span></h1>
                    <div class="tlt">
                        <ul class="texts">
                            <li>Search a music artist</li>
